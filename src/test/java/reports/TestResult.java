...
public class TestResult {
	...
	//to store test case description
	public static Map<String, String> testCaseDescription = new HashMap<String, String>();
	...
	//To store session ID
	public static Map<String, String> sessionDetails = new HashMap<String, String>();
